 ...
 *
 */
public class Exp_Regist extends JFrame{
	private static final long serialVersionUID = -18044620L;
	private JPanel jPanel01,jPanel02,jPanel03,jPanel04,jPanel05,jPanel06,jPanel07;
	...
	public Exp_Regist() throws HeadlessException {
		super("注冊表单");
		setSize(500, 485);
		...
		this.setRigistStyle();
		button.addMouseListener(new Listener(field, passwordField, checkBox, textArea, radioButton01, radioButton02));
		setVisible(true);
	}
	...
	private void setRigistStyle() {
		...
		jPanel06.setBounds(0, 200, this.getWidth(), 150);
		this.add(jPanel06);	
		...
		button.setBounds(225, 0, 70, 35);
		jPanel07.add(button);
		jPanel07.setBounds(0, 400, this.getWidth(), 50);
		this.add(jPanel07);
	}
	
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new Exp_Regist());
	}
}
